...
public class TaterzensCommand {
    ...
    public static void register(CommandDispatcher<ServerCommandSource> dispatcher, boolean dedicated) {
        dispatcher.register(literal("taterzens")
                .then(literal("config")
                        .requires(src -> permissions$checkPermission(src, PERMISSIONS.taterzens_config, config.perms.taterzensCommandPermissionLevel))
                        .then(literal("reload")
                        ...
                        .then(literal("edit")
                                .then(literal("language")
                                        .requires(src -> permissions$checkPermission(src, PERMISSIONS.taterzens_config_edit_lang, config.perms.taterzensCommandPermissionLevel))
