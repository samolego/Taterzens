...
import static org.samo_lego.taterzens.common.Taterzens.PROFESSION_TYPES;
        ...
        LiteralCommandNode<CommandSourceStack> professionsNode = literal("professions")
                ...
                .then(literal("remove")
                        ...
                        .then(argument("profession type", message())
                                ...
                                .executes(ctx -> removeProfession(ctx, ResourceLocation.parse(MessageArgument.getMessage(ctx, "profession type").getString())))
                        )
                )
                .then(literal("add")
                        ...
                        .then(argument("profession type", message())
                                ...
                                .executes(ctx -> setProfession(ctx, ResourceLocation.parse(MessageArgument.getMessage(ctx, "profession type").getString())))
                        )
                )
                .then(literal("list")
